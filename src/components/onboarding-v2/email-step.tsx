...
export function EmailStep({ email, onEmailChange, verified, onVerified, onNext }: EmailStepProps) {
        ...
        {!codeSent ? (
          ...
          >
            <div className="flex flex-col gap-2">
              <label className="text-[13px] font-medium text-page-text-muted">Email address</label>
              <input
                type="email"
