...
function AiIcon({ className }: { className?: string }) {
  return (
    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" className={className}>
      <path fillRule="evenodd" clipRule="evenodd" d="M12 1c.552 0 1 .448 1 1v1h4c1.657 0 3 1.343 3 3v5c0 .889-.386 1.687-1 2.236v1.35l1.707 1.707a1 1 0 0 1-1.414 1.414l-.319-.319C17.79 19.938 15.136 22 12 22s-5.791-2.062-6.974-4.612l-.319.319a1 1 0 0 1-1.414-1.414L5 14.586v-1.35A2.99 2.99 0 0 1 4 11V6c0-1.657 1.343-3 3-3h4V2c0-.552.448-1 1-1ZM7 5a1 1 0 0 0-1 1v5a1 1 0 0 0 1 1h10a1 1 0 0 0 1-1V6a1 1 0 0 0-1-1H7Zm2 2a1 1 0 0 1 1 1v1a1 1 0 1 1-2 0V8a1 1 0 0 1 1-1Zm6 0a1 1 0 0 1 1 1v1a1 1 0 1 1-2 0V8a1 1 0 0 1 1-1Z" fill="currentColor" />
    </svg>
  );
}
  ...
  return (
    <div className="relative flex flex-col gap-2 md:gap-3">
      ...
      <div className="flex items-center gap-2">
        ...
        <BorderBeam colorVariant="sunset" theme="auto" borderRadius={16} strength={0.35} duration={4} className="hidden flex-1 md:block">
        <div
          className={cn(
            ANALYTICS_POC_CARD_CONTAINER_CLASS,
            ANALYTICS_POC_INTERACTIVE_CARD_CLASS,
        ...
        >
          ...
          <div className="relative z-10 flex shrink-0 items-center gap-1.5">
            <AiIcon className="size-4 text-page-text-muted" />
