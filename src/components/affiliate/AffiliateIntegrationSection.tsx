...
import { IconSettings, IconActivity, IconCash } from "@tabler/icons-react";
import { THEME, type Theme } from "./affiliate-theme";
import { CarouselRow, GAP } from "./AffiliateCarouselRow";

const FEATS = [
  { icon: IconSettings, label: "Easy setup" },
  { icon: IconActivity, label: "Live tracking" },
  { icon: IconCash, label: "Auto payouts" },
];
