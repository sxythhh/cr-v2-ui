            ...
            <div className="flex flex-col rounded-[20px] bg-white dark:bg-page-bg overflow-hidden border border-border dark:border-[rgba(224,224,224,0.03)]">
              ...
              <div className="flex flex-col gap-2 px-5 pb-5 pt-4">
                ...
                <button
                  ...
                  type="button"
                >
                  <div className="flex size-10 shrink-0 items-center justify-center rounded-full shadow-[0_1px_2px_rgba(0,0,0,0.03),0_0_0_1px_rgba(229,113,0,0.08)]" style={{ background: "radial-gradient(50% 50% at 50% 100%, rgba(255,144,37,0.2) 0%, rgba(255,144,37,0) 90.69%), var(--card-bg, #FFFFFF)" }}>
