            ...
            <div className="flex flex-col rounded-[20px] bg-white dark:bg-page-bg overflow-hidden border border-border dark:border-[rgba(224,224,224,0.03)]">
              ...
              <div className="flex flex-col gap-2 px-5 pb-5 pt-4">
                ...
                <button
                  ...
                  type="button"
                >
                  <div className="flex size-10 shrink-0 items-center justify-center rounded-full border border-[rgba(229,113,0,0.08)] bg-white shadow-[0_1px_2px_rgba(0,0,0,0.03)] dark:bg-[rgba(224,224,224,0.03)]" style={{ backgroundImage: "radial-gradient(50% 50% at 50% 100%, rgba(255,144,37,0.2) 0%, rgba(255,144,37,0) 90.69%)" }}>
                ...
                >
                  <div className="flex size-10 shrink-0 items-center justify-center rounded-full border border-foreground/[0.06] bg-white shadow-[0_1px_2px_rgba(0,0,0,0.03)] dark:border-[rgba(224,224,224,0.03)] dark:bg-[rgba(224,224,224,0.03)]">
                    <svg width="17" height="17" viewBox="0 0 17 17" fill="none"><path d="M16.8454 6.25C16.8454 9.70178 14.0472 12.5 10.5954 12.5C9.73441 12.5 8.91409 12.3259 8.16772 12.011L3.94353 16.2352C3.12994 17.0488 1.81084 17.0488 0.99725 16.2352L0.610195 15.8481C-0.203398 15.0345 -0.203398 13.7155 0.610194 12.9019L4.83438 8.67767C4.51948 7.9313 4.34539 7.11098 4.34539 6.25C4.34539 2.79822 7.14361 0 10.5954 0C11.2837 0 11.9461 0.11128 12.5655 0.316833C13.0934 0.492044 13.1912 1.15417 12.7979 1.5475L10.1787 4.16667C9.48837 4.85702 9.48837 5.97631 10.1787 6.66667C10.8691 7.35702 11.9884 7.35702 12.6787 6.66667L15.2979 4.0475C15.6912 3.65417 16.3533 3.75198 16.5286 4.27992C16.7341 4.89928 16.8454 5.56165 16.8454 6.25Z" fill="currentColor" fillOpacity="0.5" /></svg>
                  </div>
                  <div className="flex min-w-0 flex-1 flex-col gap-1">
                    <div className="flex items-center gap-1.5">
