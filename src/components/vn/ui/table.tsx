...
const TableFooter = forwardRef<HTMLTableSectionElement, HTMLAttributes<HTMLTableSectionElement>>(
  ({ className, ...props }, ref) => (
    <tfoot
      ref={ref}
      className={cn('bg-zinc-900/50 font-medium border-t border-zinc-800', className)}
      {...props}
    />
  )
);
...
const TableCell = forwardRef<HTMLTableCellElement, TdHTMLAttributes<HTMLTableCellElement>>(
  ({ className, ...props }, ref) => (
    <td
      ref={ref}
      className={cn('p-4 align-middle text-zinc-100 [&:has([role=checkbox])]:pr-0', className)}
      {...props}
    />
  )
);
