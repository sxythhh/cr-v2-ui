...
function AgencyCardIllustration() {
  return (
    ...
    >
      ...
      >
        <img
          src="https://logo.clearbit.com/ogilvy.com"
          alt="Ogilvy"
          style={{
            width: 72,
            height: 72,
        ...
        />
        <img
          src="https://logo.clearbit.com/huge.co"
          alt="Huge"
          style={{
            width: 72,
            height: 72,
      ...
      >
        <img
          src="https://logo.clearbit.com/wieden-kennedy.com"
          alt="Wieden+Kennedy"
          style={{
            width: 72,
            height: 72,
        ...
        />
        <img
          src="https://logo.clearbit.com/droga5.com"
          alt="Droga5"
          style={{
            width: 72,
            height: 72,
      ...
      >
        ...
        >
          ...
          >
            <img
              src="https://logo.clearbit.com/mediamonks.com"
              alt="MediaMonks"
              style={{
                width: 52,
                height: 52,
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <img
            src="https://logo.clearbit.com/foreplay.co"
            alt="Foreplay"
            style={{
              width: 32.49,
              height: 32.49,
