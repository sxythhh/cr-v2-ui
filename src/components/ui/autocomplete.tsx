...
function AutocompleteItem({
  ...
  return (
    <AutocompletePrimitive.Item
      className={cn(
        "flex min-h-8 cursor-pointer select-none items-center gap-2 rounded-lg px-2 py-1 text-base outline-none data-disabled:pointer-events-none data-highlighted:bg-accent data-highlighted:text-foreground data-disabled:opacity-64 sm:min-h-7 sm:text-sm [&_svg]:size-4 [&_svg]:shrink-0 [&_svg]:text-muted-foreground",
        className,
      )}
