...
>(({ label, count, index, icon, className, ...props }, ref) => {
  ...
  return (
    <button
      ...
      className={cn(
        "relative z-10 flex cursor-pointer items-center whitespace-nowrap border-none bg-transparent font-[family-name:var(--font-inter)] tracking-[-0.02em] outline-none",
