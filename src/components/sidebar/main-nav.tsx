...
export function MainNav({ children }: { children: ReactNode }) {
  ...
  if (pathname?.startsWith("/lander") || pathname?.startsWith("/case-studies") || pathname?.startsWith("/academy") || pathname?.startsWith("/product-lander") || pathname?.startsWith("/verified-agency") || pathname?.startsWith("/articles") || pathname?.startsWith("/discord") || pathname?.startsWith("/blog") || pathname?.startsWith("/affiliate") || pathname?.startsWith("/agencies")) {
    return <>{children}</>;
  }
