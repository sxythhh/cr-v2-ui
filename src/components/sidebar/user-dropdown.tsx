    ...
    >
      {variant === "header" ? (
        ...
        >
          ...
          />
          <svg width="12" height="12" viewBox="0 0 12 12" fill="none" className={cn("hidden text-page-text transition-transform sm:block", show && "rotate-180")}>
...
function ProfileDropdownCompact({
  themeSubmenuOpen,
  onThemeEnter,
  onThemeLeave,
  onAccountClick,
