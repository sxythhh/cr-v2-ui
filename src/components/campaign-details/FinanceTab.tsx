  ...
  return (
    <div className="flex-1 flex flex-col gap-3 bg-white dark:bg-card-bg border border-border shadow-[0px_1px_2px_rgba(0,0,0,0.03)] rounded-2xl p-4">
      ...
      <div className="flex items-baseline justify-between">
        ...
        {secondary && (
          <span className={cn("text-[12px] tracking-[-0.02em]", secondaryColor || "text-page-text-muted")}>{secondary}</span>
        )}
      </div>
    </div>
  );
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <div className="flex flex-col gap-4 lg:flex-row">
        ...
        <div className="flex-1 flex flex-col bg-white dark:bg-card-bg border border-border shadow-[0px_1px_2px_rgba(0,0,0,0.03)] rounded-2xl p-5">
          ...
          <div className="flex items-baseline justify-between mb-3">
            <span className="text-[24px] font-medium tracking-[-0.02em] text-page-text">$11,250</span>
            <span className="text-[13px] tracking-[-0.02em] text-page-text-muted">of $15,000</span>
          </div>
      ...
      <div className="relative overflow-hidden bg-white dark:bg-card-bg border border-border shadow-[0px_1px_2px_rgba(0,0,0,0.03)] rounded-2xl">
        ...
        <div className="grid min-w-[700px] grid-cols-[80px_1fr_1fr_96px_96px_128px] px-5 py-3 border-b border-border">
        ...
        >
          ...
          {TRANSACTIONS.map((tx, i) => (
            <div
              ...
              className="relative z-10 grid min-w-[700px] grid-cols-[80px_1fr_1fr_96px_96px_128px] items-center px-5 h-14 border-b border-border last:border-b-0"
            >
              <span className="text-[13px] tracking-[-0.02em] text-page-text-muted whitespace-nowrap">{tx.date}</span>
              <div className="flex items-center gap-2 min-w-0">
                <div className={cn("w-6 h-6 rounded-full flex items-center justify-center text-[9px] font-semibold text-white shrink-0", tx.color)}>{tx.initials}</div>
                <span className="text-[13px] tracking-[-0.02em] text-page-text truncate">{tx.handle}</span>
              </div>
              <span className="text-[13px] tracking-[-0.02em] text-page-text truncate min-w-0">{tx.video}</span>
              <span className="text-[13px] tracking-[-0.02em] text-page-text text-right whitespace-nowrap">{tx.views}</span>
              <span className="text-[13px] tracking-[-0.02em] text-page-text text-right whitespace-nowrap">{tx.amount}</span>
