    ...
    <div className="mx-auto max-w-[1200px] px-4 py-5 sm:px-5">
      <div className="flex flex-col gap-2">
        ...
        <div className="grid grid-cols-1 gap-2 sm:grid-cols-2 lg:grid-cols-3">
          {STATS.map((s) => (
            <div key={s.label} className={cn(cardClass, "h-16 gap-2")}>
        ...
        {/* Tracking link card */}
        <div className={cn("flex h-16 w-full items-center justify-between rounded-2xl border border-border bg-white p-3 shadow-[0px_1px_2px_rgba(0,0,0,0.03)] dark:bg-[rgba(255,255,255,0.02)] lg:w-[320px]")}>
