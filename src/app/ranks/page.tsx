  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Circular progress ring — hidden when locked (badge SVG has its own) */}
        {!locked && (
          <svg
        ...
        {/* Locked badge icon (centered on ring) */}
        {locked && (
          <svg
            className="pointer-events-none absolute"
            width={40}
          ...
          >
            ...
            <rect x="32.826" y="60.081" width="20.5" height="9.5" rx="4.75" fill="#BAB9B9" stroke="url(#lkpg)" strokeWidth="0.5"/>
