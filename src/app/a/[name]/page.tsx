...
// TODO: Wire up real data fetching by agency slug
  ...
  campaigns: [
    {
      ...
      thumbnail: "https://saqnibxhsephhucwjbdw.supabase.co/storage/v1/object/public/campaign-thumbnails/temp_1770667130026/1770667132520.png",
      stats: [
    ...
    },
    {
      ...
      thumbnail: "https://saqnibxhsephhucwjbdw.supabase.co/storage/v1/object/public/campaign-thumbnails/temp_1770688016555/1770688017765.png",
      stats: [
    ...
    },
    {
      ...
      title: "Duel Open",
      thumbnail: "https://saqnibxhsephhucwjbdw.supabase.co/storage/v1/object/public/campaign-thumbnails/temp_1770319939461/1770319940617.png",
      stats: [
    ...
    },
    {
      ...
      title: "Bet 25 Logo",
      thumbnail: "https://saqnibxhsephhucwjbdw.supabase.co/storage/v1/object/public/campaign-thumbnails/temp_1770231205089/1770231205343.jpg",
      stats: [
...
export default async function AgencyPage({
  ...
  const { name } = await params;
  void name; // TODO: use to fetch real agency data
