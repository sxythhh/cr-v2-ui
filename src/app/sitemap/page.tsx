...
const SECTIONS = [
  ...
  },
  {
    ...
    routes: [
      ...
      { path: "/applications/1", label: "Application Detail" },
  ...
  },
  {
    ...
    routes: [
      ...
      { path: "/creator/campaign/apply", label: "Campaign Apply" },
  ...
  },
  {
    ...
    routes: [
      ...
      { path: "/admin/board", label: "Board" },
      { path: "/admin/planner", label: "Planner" },
      { path: "/admin/users", label: "Users" },
      { path: "/admin/campaigns", label: "Campaigns" },
      { path: "/admin/refunds", label: "Refunds" },
      { path: "/admin/super-admin", label: "Super Admin" },
      { path: "/admin/audit-history", label: "Audit History" },
  ...
  },
  {
    ...
    routes: [
      ...
      { path: "/agency-program", label: "Agency Program" },
      { path: "/book", label: "Book a Call" },
      { path: "/onboarding/terms", label: "Brand Onboarding" },
    ],
  },
  {
    title: "Dev",
