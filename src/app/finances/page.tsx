...
function FinanceEmptyState() {
  return (
    <div className="flex flex-1 flex-col items-center justify-center gap-4 px-5 py-20">
      <div className="relative flex size-14 items-center justify-center rounded-full border border-foreground/[0.06] bg-white shadow-[0_0_0_2px_#fff] dark:border-[rgba(224,224,224,0.03)] dark:bg-card-bg dark:shadow-none">
